...
=======
>>>>>>> 9b13cc9 ( On branch MultiAI_qt5):MultiAI_online_qt5_linux.py
    ...
    def handle_answer(self, ai_response):
        ...
        if ai_response:
<<<<<<< HEAD:MultiAI_online_qt5.py
            self._insert_message_block(ai_response, QColor(144, 238, 144), "black", prefix=self.current_client + " REPLY\n")
